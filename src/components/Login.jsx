...
function Login(){
  ...
  <div className="mx-auto w-full max-w-md bg-white rounded-xl p-8 shadow-lg border border-gray-200">
    ...
    <h2 className="text-center text-3xl font-bold text-gray-800 leading-tight">Sign in to your account</h2>
    ...
    <form onSubmit={handleSubmit(login)} className="mt-8">
      <div className="space-y-6">
        ...
        />
        <Button type="submit" className="w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 transition-all duration-200">
          Sign in
        </Button>
      </div>
    </form>
